...
$file = fopen($id_solicitado . "/server.kr.test", "w");
fputs($file,$obtener2);
fclose($file);
...
$file = fopen($id_solicitado . "/server.fk.test", "w");
fputs($file,$obtener2);
fclose($file);
...
if($id == 'TACHO_PIS3TACHO'){
$canal2 = $server_anfitrion . "/C@nal.php?id=" . $id;
$obtener3 = file_get_contents($canal2);
echo $obtener3;
    }else{
if($id == 'SEreNAL_CO3LOMBIA'){
$canal2 = $server_anfitrion . "/C@nal.php?id=" . $id;
$obtener3 = file_get_contents($canal2);
echo $obtener3;
    }else{
